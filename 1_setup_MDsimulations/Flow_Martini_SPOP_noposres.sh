#!/bin/bash
#
#Script to coarse-grain and run energy minimization of SPOP oligomers
...
#Put protein in box
$gmx editconf -f PRO_CG.pdb -o PRO_CG.gro -bt dodecahedron -d 2.5 -center 0 0 0 -princ <<EOF
1
EOF
